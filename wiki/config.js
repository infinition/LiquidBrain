...
const CONFIG = {
    ...
    projectName: "LIQUIDBRAIN",
    projectSubtitle: "LIQUIDBRAIN WIKI",
    description: "Official Documentation and Wiki for LiquidBrain",

    // Versioning Settings
    versioning: {
        type: "local",
        manualVersion: "v1.0.0",
        manualDate: "2026-03-04"
    },

    // GitHub Repository
    repo: "infinition/LiquidBrain",
    branch: "main",
    ...
    // Footer
    footerText: "© 2026 LIQUIDBRAIN WIKI - All rights reserved",
    ...
    social: {
        discord: null,
        reddit: null,
        github: "https://github.com/infinition/LiquidBrain", // Virgule respectée par le script
